			...
			<div class="container-fluid">
				<div class="navbar-header">
					<a class="navbar-brand" href="index.php"><?print $title;?></a>
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"> AltisLife Whitelist Server <b class="caret"></b></a>
							<ul class="dropdown-menu">
								<li><a href="../public">AltisLife Public Server</a></li>
								<?php if($admin->whitelist == 1){ ?>
									<li><a href="">AltisLife Whitelist Server</a></li>
								<?php } ?>
							</ul>
						</li>
					</ul>
