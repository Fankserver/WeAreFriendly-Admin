...
<html lang="en">
	...
	<div class="container-fluid">
		<div class="row placeholders">
			...
			<?php
			$altislife->lesen($tabelle, "where modleitung=1", "admin", "");
			?>
				<div class="col-md-6">
				...
				if($_GET["abfrage"] == 1){
				$altislife->lesen($tabelle, $suchabfrage, $sortierung, "");
				?>
				<div class="col-md-12">
					...
					<div class="table-responsive">
						<table class="table table-striped">
							...
							<tbody>
								...
								?>
									<tr>
										<td><a href="vehicle.php?playerid=<?print $players->playerid;?>"><?print $players->playerid;?></a></td>
										<td><?print utf8_decode($players->name);?></td>
										<?php
										$vehicle=$altislife->lesen("vehicles", "pid=".$players->playerid." AND alive=1", "", "", "J");
										?>
										<td>
										<?php 
										$v=0;
										while($v<mysql_num_rows($vehicle)){
											$vehicles=mysql_fetch_object($vehicle);
											print utf8_decode($vehicles->classname)." ";
											$v++;
										}?>
										</td>
									</tr>
